...
const articles = [
  {
    ...
    excerpt: 'דף נחיתה AI שנבנה תוך שעה עם Lovable יכול להמיר טוב לא פחות מדף מעוצב מקצועי. נתוני המרה אמיתיים מ-2026, מחירים בישראל, ואיך בודקים אם הדף שלכם באמת עובד.',
    readTime: '10 דקות קריאה',
    href: '/blog/ai-landing-page-conversion-test',
  },
  {
    title: 'אוטומציה לאיש מכירות — פולו-אפ, לידים וסגירות',
    category: 'אוטומציה-ענף',
    excerpt: 'אוטומציה למכירות תופסת כל ליד שנשכח בין שיחה לשיחה — 80% מהעסקאות דורשות חמישה מעקבים ומעלה, אבל רוב הנציגים מוותרים אחרי ארבעה. כמה זה עולה וכמה זה שווה בפועל.',
    readTime: '10 דקות קריאה',
    href: '/blog/sales-person-automation',
  },
  {
    title: 'אינטגרציה CRM + וואטסאפ + מייל — המדריך המלא',
    category: 'אוטומציה',
    excerpt: 'אינטגרציה בין CRM, וואטסאפ ומייל מונעת אובדן לידים בין הערוצים. כמה זה עולה בישראל ב-2026, אילו טעויות שוברות אינטגרציות, ואיך זה נראה ביום-יום.',
    readTime: '11 דקות קריאה',
    href: '/blog/crm-whatsapp-email-integration',
  },
  {
    title: 'אתר תדמית עם AI מול חברת פיתוח — למי מהמקצועות זה מתאים',
    category: 'כלי No-Code',
    excerpt: 'אתר תדמית AI מספיק ל-90% מהעסקים הקטנים, אבל לא לכולם. מדריך מחירים בישראל ב-2026 ולאילו מקצועות דווקא כדאי חברת פיתוח.',
    readTime: '11 דקות קריאה',
    href: '/blog/ai-website-vs-development-agency',
  },
  {
    title: 'אוטומציה לסוכן ביטוח — לידים, מעקב וחידושים',
    category: 'אוטומציה-ענף',
    excerpt: 'אוטומציה לסוכן ביטוח תופסת ליד תוך דקות ושומרת על שיעור חידוש גבוה בפוליסות קיימות. כמה זה עולה, כמה זמן זה חוסך, ואיך זה נראה ביום-יום.',
    readTime: '10 דקות קריאה',
    href: '/blog/insurance-agent-automation',
  },
  {
